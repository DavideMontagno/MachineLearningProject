...
D_in = 20 
D_out = 2
nUnitLayers = [25] #A:25,30 D: 35,40
batch_size = 96 #A: 8,32
etas = [0.01] #A:0.001,0.002,0.003,0.004 D: 0.005,0.007,0.009, 0.01
alphas = [0.85] #0.9,0.85,0.8
lambdas = [0.01] #A: D:0.005, 0.007, 0.01
nFold=0
nEpoch = 100 
splits_kfold = 10 
            ...
            for alpha in alphas:
                for lambda_param in lambdas:
                    ...
                    for traing_index, test_index in kfold.split(X):
                        ...
                        print('...Ended phase',nFold+1,'of ',splits_kfold) 
                    ...
                    print('Average TR:',averageLoss,'- Average TS:',averageLossTs)
                    print('Creating plot...')
